...
import { gender, Vendor } from "../entities/vendor";
...
const vendorRegisterSchema = z.object({
	...
	gender: z.enum(["male", "female", "other"]),
	location: z.string(),
	preferredWorkLocation: z.enum(["inside_city", "outside_city", "other"]),
	documentType: z.enum(["aadhar", "pan", "driving_license", "voter_id", "password"])
})
...
// vendor register 
// async vendorRegister(req:Request, res:Response, next:NextFunction){
// 	try {
// 		const { name, phone, email, password, gender, location, preferredWorkLocation, documentType} = vendorRegisterSchema.parse(req.body)
